...
tic;
[input_image_1, map] = imread('../data/circles_concentric.png');
...
% interpolation algorithm to fill in the pixels.
[input_image_2, map] = imread('../data/barbaraSmall.png');
output_image_scaled_1 = myBilinearInterpolation(input_image_2, 3,2);
%%
...
% In this section, the MyNearestNeighborInterpolation function scales
...
[output_image_scaled_2] = myNearestNeighborInterpolation(input_image_2, 3,2);
